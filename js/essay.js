  ...
  changeTimeInEssay: function () {
    document.querySelector("#bber") &&
      document.querySelectorAll("#bber time").forEach(function (e) {
        ...
        (t.innerText = anzhiyu_essay.diffDate(datetime, true)), (t.style.display = "inline");
      });
  },
...
anzhiyu_essay.initIndexEssay();
anzhiyu_essay.changeTimeInEssay();
anzhiyu_essay.reflashEssayWaterFall();